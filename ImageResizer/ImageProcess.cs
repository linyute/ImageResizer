...
namespace ImageResizer
{
    public class ImageProcess
    {
        ...
        public void ResizeImages(string sourcePath, string destPath, double scale)
        {
            ...
            {
                ResizeImage(filePath, scale, destPath);
            }
        }
        ...
        public void ResizeImagesParallel(string sourcePath, string destPath, double scale)
        {
            ...
            Parallel.ForEach(allFiles, filePath => ResizeImage(filePath, scale, destPath));

            //allFiles.AsParallel().ForAll(filePath => ResizeImage(filePath, scale, destPath));
        }
        ...
        /// <param name="destPath">產生圖片目的目錄路徑</param>
        /// <param name="scale">縮放比例</param>
        public Task ResizeImagesParallelAsync(string sourcePath, string destPath, double scale)
        {
            var allFiles = FindImages(sourcePath);

            var tasks = allFiles.AsParallel().Select(
                filePath => Task.Run(
                    () => ResizeImage(filePath, scale, destPath))
            );
        ...
        public void ResizeImage(string filePath, double scale, string destPath)
        {
